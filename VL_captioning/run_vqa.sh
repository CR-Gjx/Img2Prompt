...
--config ./configs/VQA_test_caption.yaml --dataset 'vqa' \
--output_dir './output_new/vqa_result/' \
--caption_file '../caption_question_files/vqa_val_caption.json' \
--question_file '../caption_question_files/vqa_val_question.json'  \
--ans_dict_file '../caption_question_files/vqa_val_ans_to_cap_dict.json' \
